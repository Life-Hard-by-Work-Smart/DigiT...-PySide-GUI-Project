"""
Clinical metrics computation for cervical spine X-ray analysis.
Adapted from toBeIntegrated/Src/Atlas/draw_metrics.py
"""
...
def get_endplate(pts: Dict[str, Point], vertebra: str, plate: str):
    """plate: 'top' or 'bottom'; returns (left_point, right_point)"""
